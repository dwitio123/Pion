...
public class LoginAbsenGuruActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_login_absen_guru);
        ...
        getSupportActionBar().setTitle("Absensi Guru");
    }
        ...
        call.enqueue(new Callback<Response>() {
            ...
            public void onResponse(Call<Response> call, retrofit2.Response<Response> response) {
                if (response.body().getResponse().equals("success")){
                    Intent intent = new Intent(LoginAbsenGuruActivity.this, AbsenGuruActivity.class);
                    startActivity(intent);
                    progressDialog.hide();
                    edit_user.getEditText().setText("");
                    edit_pass.getEditText().setText("");
                } else {
                    Toast.makeText(LoginAbsenGuruActivity.this, "Username atau password salah", Toast.LENGTH_SHORT).show();
                    progressDialog.hide();
                }
            }
