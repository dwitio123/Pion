...
public class TugasSiswaActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tugas_siswa2);
        ...
        rc_tugas.setAdapter(new TugasAdapter2(tugasGuru));
    ...
    private void DataTugas(){
        ...
        Call<Tugas> call = apiInterface.getReadTugas(bundle.getString("kelas"), bundle.getString("jurusan"));
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        if (item.getItemId() == R.id.menu_filter){
            DatePickerDialog datePickerDialog = new DatePickerDialog(TugasSiswaActivity2.this, new DatePickerDialog.OnDateSetListener() {
                @Override
                public void onDateSet(DatePicker view, int year, int month, int dayOfMonth) {
                    ...
                    ApiInterface apiInterface = Api.getUrl().create(ApiInterface.class);
                    Call<Tugas> call = apiInterface.getFilterTugas(bundle.getString("kelas"), bundle.getString("jurusan"), tgl);
                    call.enqueue(new Callback<Tugas>() {
                        @Override
                        public void onResponse(Call<Tugas> call, Response<Tugas> response) {
                            swipe_refresh_tugas.setRefreshing(false);
